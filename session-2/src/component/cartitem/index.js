...
const cartitem = ({ image, title, id, price, qty, RemoveFromCart }) => {
  return (
    <tr>
      ...
      <td>
        ...
        {/* <button type="submit" onClick={() => RemoveFromCart(id)} className="text-gray-700 md:ml-4"> */}
      ...
      <td className="text-right">
        <span className="text-sm lg:text-base font-medium">USD {price * qty}</span>
      </td>
    </tr>
  );
};
