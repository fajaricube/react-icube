...
const ProductDetail = () => {
  ...
  const AddCart = id_product => {
    const value = {
      ...
      title: document.getElementById('name-product').innerText,
      qty: document.getElementById('qty').innerText,
      price: document.getElementById('price').innerText,
      image: document.getElementById('image').innerText,
    };
    dispatch(Cart(value));
    history.push('/cart');
  };
      ...
      <div className="container mx-auto px-6">
        <div className="md:flex md:items-center">
          ...
          <div className="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
            <h3 className="text-gray-700 uppercase text-lg" id="name-product">
              {result.product.title}
            </h3>
            <p className="text-gray-700  text-xs">{result.product.description}</p>
            <span className="text-gray-500 mt-3" id="price">
              USD {result.product.price}
            </span>
            <div className="hidden" id="price">
              {result.product.id}
            </div>
            <div className="hidden" id="image">
            ...
            <div className="mt-2">
              ...
              <div className="flex items-center mt-1">
                ...
                <span className="text-gray-700 text-lg mx-2" id="qty">
                  {count}
                </span>
                <button
                  className="text-gray-500 focus:outline-none focus:text-gray-600"
